package com.wallet.main.wallettracker.hibernate.dialect;
...
public class SQLiteDialect extends Dialect {
  ...
  protected String columnType(int sqlTypeCode) {
    switch (sqlTypeCode) {
      case DECIMAL:
        return getVersion().isBefore(3) ? columnType(SqlTypes.NUMERIC)
  ...
  private static class SQLiteUniqueDelegate extends AlterTableUniqueDelegate {
    ...
    /**
     * Alter table support in SQLite is very limited and does not include adding a unique constraint
     * (as of 9/2023).
     *
  ...
  @Override
  public String timestampdiffPattern(TemporalUnit unit, TemporalType fromTemporalType,
  ...
  public void initializeFunctionRegistry(FunctionContributions functionContributions) {
    ...
    final BasicTypeRegistry basicTypeRegistry = functionContributions.getTypeConfiguration()
  ...
  public void appendDateTimeLiteral(
    ...
    switch (precision) {
      ...
      case TIMESTAMP:
        ...
        appendAsTimestampWithNanos(appender, temporalAccessor, supportsTemporalLiteralOffset(),
            jdbcTimeZone);
        appender.appendSql(')');
        break;
      default:
  ...
  @Override
  public void appendDateTimeLiteral(SqlAppender appender, Date date, TemporalType precision,
      TimeZone jdbcTimeZone) {
    switch (precision) {
      case DATE:
        appender.appendSql("date(");
